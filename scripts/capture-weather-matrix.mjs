...
const scenarios = [
  ...
  {
    id: 'phenomena-dew-sunrise-clear',
    env: {
      PIECZARGOTCHI_DEBUG_WEATHER: 'clear',
      PIECZARGOTCHI_DEBUG_CLOUD: '8',
      PIECZARGOTCHI_DEBUG_WIND: '2',
      PIECZARGOTCHI_DEBUG_HUMIDITY: '96',
      PIECZARGOTCHI_DEBUG_TEMPERATURE: '9',
  ...
  {
    id: 'phenomena-frost-cold-morning',
    env: {
      PIECZARGOTCHI_DEBUG_WEATHER: 'clear',
      PIECZARGOTCHI_DEBUG_CLOUD: '10',
      PIECZARGOTCHI_DEBUG_WIND: '3',
      PIECZARGOTCHI_DEBUG_HUMIDITY: '93',
      PIECZARGOTCHI_DEBUG_TEMPERATURE: '-3',
  ...
  {
    id: 'phenomena-fogbow-low-sun',
    env: {
      PIECZARGOTCHI_DEBUG_WEATHER: 'fog',
      PIECZARGOTCHI_DEBUG_CLOUD: '42',
      PIECZARGOTCHI_DEBUG_CLOUD_LOW: '28',
      PIECZARGOTCHI_DEBUG_CLOUD_HIGH: '32',
      PIECZARGOTCHI_DEBUG_WIND: '3',
      PIECZARGOTCHI_DEBUG_HUMIDITY: '98',
  ...
  {
    id: 'phenomena-moon-halo-cloudy-night',
    env: {
      PIECZARGOTCHI_DEBUG_WEATHER: 'cloudy',
      PIECZARGOTCHI_DEBUG_CLOUD: '58',
      PIECZARGOTCHI_DEBUG_CLOUD_LOW: '12',
      PIECZARGOTCHI_DEBUG_CLOUD_MID: '30',
  ...
  {
    id: 'phenomena-warm-rain-steam',
    env: {
      PIECZARGOTCHI_DEBUG_WEATHER: 'clear',
      PIECZARGOTCHI_DEBUG_CLOUD: '24',
  ...
  {
    id: 'phenomena-heat-haze-dry-noon',
    env: {
      PIECZARGOTCHI_DEBUG_WEATHER: 'clear',
      PIECZARGOTCHI_DEBUG_CLOUD: '8',
      PIECZARGOTCHI_DEBUG_WIND: '3',
      PIECZARGOTCHI_DEBUG_HUMIDITY: '28',
  ...
  {
    id: 'red-rainbow-sunset',
    env: {
      PIECZARGOTCHI_DEBUG_WEATHER: 'rain',
      PIECZARGOTCHI_DEBUG_PRECIPITATION: '0.9',
      PIECZARGOTCHI_DEBUG_CLOUD: '38',
      PIECZARGOTCHI_DEBUG_CLOUD_LOW: '18',
      PIECZARGOTCHI_DEBUG_CLOUD_MID: '26',
      PIECZARGOTCHI_DEBUG_CLOUD_HIGH: '24',
  ...
  {
    id: 'red-double-rainbow-clearing',
    env: {
      PIECZARGOTCHI_DEBUG_WEATHER: 'rain',
      PIECZARGOTCHI_DEBUG_PRECIPITATION: '2.4',
      PIECZARGOTCHI_DEBUG_CLOUD: '36',
      PIECZARGOTCHI_DEBUG_CLOUD_LOW: '14',
      PIECZARGOTCHI_DEBUG_CLOUD_MID: '24',
      PIECZARGOTCHI_DEBUG_CLOUD_HIGH: '30',
      PIECZARGOTCHI_DEBUG_HUMIDITY: '90',
  ...
  {
    id: 'phenomena-cloud-iridescence-thin-cloud',
    env: {
      PIECZARGOTCHI_DEBUG_WEATHER: 'clear',
      PIECZARGOTCHI_DEBUG_CLOUD: '44',
      PIECZARGOTCHI_DEBUG_CLOUD_LOW: '4',
  ...
  {
    id: 'phenomena-sun-dog-cold-low-sun',
    env: {
      PIECZARGOTCHI_DEBUG_WEATHER: 'clear',
      PIECZARGOTCHI_DEBUG_CLOUD: '54',
      PIECZARGOTCHI_DEBUG_CLOUD_LOW: '6',
      PIECZARGOTCHI_DEBUG_CLOUD_MID: '18',
      PIECZARGOTCHI_DEBUG_CLOUD_HIGH: '74',
      PIECZARGOTCHI_DEBUG_TEMPERATURE: '-5',
  ...
  {
    id: 'phenomena-light-pillar-frost-dawn',
    env: {
      PIECZARGOTCHI_DEBUG_WEATHER: 'clear',
      PIECZARGOTCHI_DEBUG_CLOUD: '58',
      PIECZARGOTCHI_DEBUG_CLOUD_LOW: '5',
      PIECZARGOTCHI_DEBUG_CLOUD_MID: '16',
      PIECZARGOTCHI_DEBUG_CLOUD_HIGH: '82',
      PIECZARGOTCHI_DEBUG_TEMPERATURE: '-8',
      PIECZARGOTCHI_DEBUG_WIND: '2',
      PIECZARGOTCHI_DEBUG_VISIBILITY: '9000',
      PIECZARGOTCHI_DEBUG_LOCATION: 'katowice',
  ...
  {
    id: 'noctilucent-summer-twilight',
    env: {
      PIECZARGOTCHI_DEBUG_WEATHER: 'clear',
      PIECZARGOTCHI_DEBUG_CLOUD: '4',
      PIECZARGOTCHI_DEBUG_CLOUD_LOW: '0',
      PIECZARGOTCHI_DEBUG_CLOUD_MID: '2',
