...
- Rzadki dzienny easter egg `:|` jest deterministyczny per zapis i data; debug menu pozwala wymusić wariant zadowolony, gniewny albo Iwoniaście, a runtime używa osobnych neutralnych sprite sheetów.
